...
alias nurdget='cd ~/Desktop; rm NURDVision.cpp;wget https://github.com/FRCTeam3255/NURDVision/blob/master/NURDVision.cpp;  echo "$(tput bold)$(tput setaf 4)NURD$(tput setaf 1)Vision $(tput setaf 2)Downloaded successfully"'
